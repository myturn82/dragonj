        ...
        <header className="bg-[#f7f7f7] border-b border-gray-200 sticky top-0 z-50">
          <nav className="max-w-[1440px] mx-auto flex items-center justify-between h-[64px] px-10">
            ...
            <ul className="hidden xl:flex gap-10 text-lg font-semibold text-[#1d1d1f] whitespace-nowrap">
              ...
              <li><Link href="/contact" className="hover:text-[var(--primary)] transition whitespace-nowrap">문의하기</Link></li>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="ml-2 px-4 py-2 rounded bg-gray-200 text-gray-700 text-sm font-semibold hover:bg-gray-300 transition hidden xl:inline-block"
              >
                로그아웃
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="xl:hidden bg-white shadow-lg rounded-b-2xl animate-fade-in">
              ...
              <button
                ...
                className="w-full mt-4 px-4 py-2 rounded bg-gray-200 text-gray-700 text-sm font-semibold hover:bg-gray-300 transition"
              >
                로그아웃
              </button>
            </div>
